    ...
    <div data-scroll data-scroll-section data-scroll-speed=".08" className='w-full flex gap-10 h-screen font-["Founders_Grotesk_X_Condensed"]   '>
      <div className="text-[8rem] h-screen flex flex-col justify-between w-1/2 uppercase  p-20 font-bold leading-none tracking-tight">
        ...
        <div className="text-[2rem]  leading-none  capitalize mt-10">
            ...
            <a className="block" href="instagram">instagram</a>
            <a className="block" href="facebook">facebook</a>
            <a className="block" href="behance">behance</a>
            <a className="block" href="">linkdedin</a>
        </div>
       

        <div className="text-[2rem]  leading-none    capitalize mt-10">
            <h1>L:</h1>
            <a className="block mb-2" href="">202-1965 W 4th Ave</a>
            <a className="block mb-2" href="">Vancouver, Canada</a>
            <div>
                <a className="block mb-2" href="">30 Chukarina St</a>
                <a className="block mb-2" href="">Lviv, Ukraine</a>
            </div>
       
        </div>
     

        <div className="text-[2rem]  leading-none   mt-10">
            <h1>E:</h1>
