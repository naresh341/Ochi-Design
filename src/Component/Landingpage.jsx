                ...
                <div className="w-fit flex items-end overflow-hidden ">
                  {index == 1 && (
                    <motion.div
                      ...
                      className=" mr-[1rem] w-[11rem] h-[5.7rem] relative -top-[2.5rem] rounded-md bg-[url('https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg')] bg-cover"
                    ></motion.div>
                  )}
                  <h1 className='uppercase text-[9.5rem] pt-[2rem] -mb-[-0rem] font-bold leading-[0.75] font-["Founders_Grotesk_X_Condensed"]'>
                    {item}
                  </h1>
                </div>
              </div>
